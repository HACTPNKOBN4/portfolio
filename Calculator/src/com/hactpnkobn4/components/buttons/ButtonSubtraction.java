...
public class ButtonSubtraction extends JButton implements Operation {

	public static final Operation SUBTRACTION = new ButtonSubtraction();
	
	public ButtonSubtraction() {
		setText("-");
